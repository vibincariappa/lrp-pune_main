  ...
  return (
    <div className="bg-background text-on-surface font-body-md selection:bg-secondary-fixed selection:text-on-secondary-fixed min-h-screen">
      ...
      <main className="pt-20">
        {/* 1. Immersive Centered Hero Section with Integrated Three.js Network Background */}
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-margin-desktop max-w-7xl mx-auto py-24 text-center">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="relative z-10 max-w-4xl mx-auto flex flex-col items-center gap-6 pt-12"
          >
            <motion.span
            ...
            <motion.div
              variants={itemVariants}
              className="flex flex-wrap gap-6 justify-center mt-12 w-full max-w-lg"
            >
              {/* Metric Card 1 */}
              <div className="bg-white/40 backdrop-blur-md border border-outline-variant/30 p-6 rounded-xl flex-1 min-w-[200px] flex flex-col gap-2 shadow-sm hover:border-primary/40 hover:-translate-y-0.5 transition-all duration-300">
        ...
        {/* 2. Pillar Overview */}
        <section id="overview" className="py-stack-lg bg-surface-container-low px-margin-desktop scroll-mt-20 max-w-7xl mx-auto">
        ...
        {/* 7. Timeline */}
        <section id="timeline-section" className="py-stack-lg px-margin-desktop bg-white max-w-7xl mx-auto">
